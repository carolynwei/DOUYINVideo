...
STYLE_DESCRIPTIONS = {
    "🐱 万物有灵·叙事者": {
        "icon": "🐱",
        "desc": "非人类主角+人间观察。用猫、金鱼、盆栽等意想不到视角讲述人类故事。自带诗意、反差萌和哲学感，发现平凡生活中的不凡诗意。",
        "formula": "视角设定+观察到的现象+内心独白（产生共鸣/误解）+温暖的结论。'我是家里那只橘猫，今天主人对着手机哭了很久...其实她不知道，我也觉得还好有她。'",
        "适配度": "极高（独特视角，情感共鸣强）",
        "visual": "镜头：低机位（模拟动物高度）、固定镜头为主 | 色调：Wes Anderson对称美学+宫崎骏温暖色调 | BGM：治愈系轻音乐、大提琴或钢琴独奏",
        "reference": "Wes Anderson + 宫崎骏"
    },
    "💡 认知唤醒·灯塔": {
        "icon": "💡",
        "desc": "从'摧毁认知'到'点亮认知'。不给焦虑，给解药；不制造恐慌，给希望。让观众获得向上的力量。",
        "formula": "温柔的破题+多维度的论证+富有哲思的升华。'我们总说生活很苦，但如果你把熬过去换成闯过去，你会发现手里一直握着那把开门的钥匙。'",
        "适配度": "极高（正能量传播）",
        "visual": "镜头：慢镜头、大光圈、捕捉光影流动 | 色调：人文纪实+极简主义，《白日梦想家》辽阔感 | BGM：史诗级但非压迫性的弦乐，空灵人声哼唱",
        "reference": "《白日梦想家》+《小森林》"
    },
    "🤝 共创养成·家人": {
        "icon": "🤝",
        "desc": "从'我要火'到'我们一起长大'。互动不再是索取流量，而是真诚的分享与共建。展现人与人之间的善意连接。",
        "formula": "展示现状+提出困惑+邀请共创+感恩反馈。'想做一期关于告别的视频，总觉得差点意思。评论区都是我的云家人，能不能分享一下你们最温暖的一次告别？'",
        "适配度": "高（深度粉丝关系）",
        "visual": "镜头：对着镜头说话、眼神交流、拍摄用户来信 | 色调：真实Vlog质感，不追求过度精致 | BGM：温暖简单吉他曲，用户投稿原创音乐",
        "reference": "真实Vlog美学"
    },
    "🎭 POV代入·影子": {
        "icon": "🎭",
        "desc": "从'代入受害者'到'代入见证者/陪伴者'。让观众代入默默陪着你的朋友、另一个自己，或是内心的影子。提供无声的陪伴与支持。",
        "formula": "'如果你现在正一个人躲在楼梯间偷偷难过，别怕，我是那个蹲在角落里陪着你的影子。只要有光，我就一直在。'",
        "适配度": "极高（情感陪伴）",
        "visual": "镜头：第三人称跟随视角、影子特写、雨滴滑过玻璃 | 色调：光影艺术+意识流，朦胧但充满安全感 | BGM：极简钢琴、心跳声、轻柔白噪音",
        "reference": "光影艺术 + 意识流电影"
    },
    "⚡ 情绪升华·破晓": {
        "icon": "⚡",
        "desc": "从'发泄爽感'到'涅槃重生'。保留反转和戏剧性，但落脚点是战胜自己后的平和与力量。展现人性的坚韧。",
        "formula": "展示深渊+挣扎过程+迎来破晓+回望的淡然。'那天我弄丢了一切...我坐在凌晨四点的马路边哭得像条狗。然后，我等来了当天的第一缕阳光。'",
        "适配度": "极高（励志共鸣）",
        "visual": "镜头：前期快速剪辑表现混乱，后期长镜头表现平静 | 色调：前期黑白/冷色，后期彩色/暖色 | BGM：前期压抑电子，后期宏大人声交响",
        "reference": "《海边的曼彻斯特》到《心灵奇旅》"
    },
    "🧘 解忧陪伴·树洞": {
        "icon": "🧘",
        "desc": "不输出，只倾听。打造赛博空间里的解忧杂货店。视频本身就是一种无声的陪伴，允许观众在这里放下疲惫。",
        "formula": "极简文案或无文案。画面本身就是语言。深夜便利店、雨中路灯、慢慢爬的蜗牛。配上字幕：'今晚，我在这里陪你。'",
        "适配度": "极高（深夜陪伴）",
        "visual": "镜头：固定机位，长镜头，观察生活细微之美 | 色调：新海诚风格治愈系空镜+深夜食堂烟火气 | BGM：Lofi Hip Hop、爵士乐、黑胶唱片底噪",
        "reference": "新海诚 + 深夜食堂"
    }
}
