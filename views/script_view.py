...
STYLE_DESCRIPTIONS = {
    ...
    "听劝养成 - 互动率04+评论爆炸": {
        ...
        "formula": "大家说我XX，我改了，你们看现在呢？或接受全网建议改稿的第X天",
        "适配度": "中（需要多轮对话调整）",
    ...
    "情绪宣泄 - 极致反转+发疯文学": {
        ...
        "formula": "短剧逻辑，前面有多憋屈，后面就有多爽。或用极其发疯的口吻说出不敢说的话",
        "适配度": "极高（配合火山TTS暴躁音色）",
    ...
    "Meme抗象 - 低成本+病毒传播": {
        "icon": "Meme",
        "desc": "用流行梗解说严肃内容。核心：解压+洗脑+病毒式传播+幽默",
...
BUTTON_LABELS = {
    "认知刺客 - 冲击力+优越感": "召唤认知刺客",
    "听劝养成 - 互动率04+评论爆炸": "召唤养成系博主",
    "POV沉浸 - 第一人称+代入感": "召唤POV导演",
    "情绪宣泄 - 极致反转+发疯文学": "召唤情绪大师",
    "Meme抗象 - 低成本+病毒传播": "召唤Meme创作者"
}
